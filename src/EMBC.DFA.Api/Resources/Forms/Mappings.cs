...
namespace EMBC.DFA.Api.Resources.Forms
{
    public class Mappings : Profile
    {
        public Mappings()
        {
            CreateMap<SmbForm, incident>(MemberList.None)
                .IncludeAllDerived()
                ...
                //.ForMember(d => d., opts => opts.MapFrom(s => s.IsBusinessManaged))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.AreRevenuesInRange))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.EmployLessThanFifty))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.DevelopingOperaton))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.FullTimeFarmer))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.MajorityIncome))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.CouldNotPurchaseInsurance))
                ...
                //.ForMember(d => d., opts => opts.MapFrom(s => s.HasFinancialStatements))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.HasTaxReturn))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.HasProofOfOwnership))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.HasListOfDirectors))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.HasProofOfRegistration))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.HasEligibilityDocuments))
            ...
            CreateMap<IndForm, incident>(MemberList.None)
                .IncludeAllDerived()
                .ForMember(d => d.dfa_applicanttype, opts => opts.MapFrom(s => (int?)Enum.Parse<ApplicantTypeOptionSet>(s.ApplicantType.ToString())))
                .ForMember(d => d.dfa_indigenousstatus, opts => opts.MapFrom(s => s.IndigenousStatus))
                .ForMember(d => d.dfa_onfirstnationsreserve, opts => opts.MapFrom(s => s.OnFirstNationReserve))
                ...
                .ForMember(d => d.dfa_doyouhaveinsurancecoverage, opts => opts.MapFrom(s => s.HasInsurance))
                .ForMember(d => d.dfa_isthispropertyyourprimaryresidence, opts => opts.MapFrom(s => s.IsPrimaryResidence))
                .ForMember(d => d.dfa_eligibleforbchomegrantonthisproperty, opts => opts.MapFrom(s => s.EligibleForGrant))
                .ForMember(d => d.dfa_doyourlossestotalmorethan1000, opts => opts.MapFrom(s => s.LossesOverOneThousand))
                .ForMember(d => d.dfa_wereyouevacuatedduringtheevent, opts => opts.MapFrom(s => s.WasEvacuated))
                .ForMember(d => d.dfa_areyounowresidingintheresidence, opts => opts.MapFrom(s => s.InResidence))
                .ForMember(d => d.dfa_datereturntotheresidence, opts => opts.MapFrom(s => s.DateReturned))
            ...
            CreateMap<GovForm, incident>(MemberList.None)
                .IncludeAllDerived()
                .IncludeAllDerived()
                .ForMember(d => d.dfa_applicanttype, opts => opts.MapFrom(s => (int?)Enum.Parse<ApplicantTypeOptionSet>(s.ApplicantType.ToString())))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.GovLegalName))
                //.ForMember(d => d., opts => opts.MapFrom(s => s.Date))

                .ForMember(d => d.customerid_contact, opts => opts.MapFrom(s => s.Applicant))
                .ForMember(d => d.dfa_dateofdamage, opts => opts.MapFrom(s => s.DamageFrom))
                .ForMember(d => d.dfa_dateofdamageto, opts => opts.MapFrom(s => s.DamageTo))

                .ForMember(d => d.dfa_damagedpropertystreet1, opts => opts.MapFrom(s => s.MailingAddress != null ? s.MailingAddress.AddressLine1 : string.Empty))
                .ForMember(d => d.dfa_damagedpropertystreet2, opts => opts.MapFrom(s => s.MailingAddress != null ? s.MailingAddress.AddressLine2 : string.Empty))
                .ForMember(d => d.dfa_damagedpropertycity, opts => opts.MapFrom(s => s.MailingAddress != null ? s.MailingAddress.City : string.Empty))
                .ForMember(d => d.dfa_damagedpropertyprovince, opts => opts.MapFrom(s => s.MailingAddress != null ? s.MailingAddress.Province : string.Empty))
                .ForMember(d => d.dfa_damagedpropertypostalcode, opts => opts.MapFrom(s => s.MailingAddress != null ? s.MailingAddress.PostalCode : string.Empty))
                ...
                .ForMember(d => d.dfa_issamemailingaddress, opts => opts.MapFrom(s => true))
